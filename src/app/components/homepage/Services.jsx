...
const Services = () => {
  return (
    <div className='bg-white w-full h-auto px-7 py-12 lg:p-20 ' id="services" >
      <div className='flex justify-between mb-5 lg:items-center gap-10 flex-col lg:flex-row'>
        <h1 className='text-4xl text-[#000000] lg:mb-10 lg:w-[30%]'>Services</h1>
        <div className="lg:w-[70%] gap-4">
          <div className="flex justify-between w-full">
            <h4 className='lg:w-[20%]'></h4>
            <p className="lg:w-[80%] leading-[30px]">At <strong>int+</strong>, our services are crafted to empower your business and fuel success. We prioritize <strong>efficiency, innovation, and customer satisfaction</strong> in a comprehensive suite that spans crucial business functions, ensuring your journey towards success is seamless and effective</p>
          </div>
        </div>
      </div>
      <div className='h-[2px] bg-[#00000040] w-full mb-10'></div>
      <div className="flex lg:justify-between gap-4 overflow-x-scroll no-scrollbar leading-[19px]">
