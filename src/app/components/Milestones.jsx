...
const Milestones = () => {
  return (
    <div className='bg-white w-full h-auto px-20 py-10 flex flex-col gap-6'>
      <h1  className='text-3xl text-[#000000] mb-3 w-[30%]'>Milestones</h1>
      <div className='h-[2px] bg-[#00000040] w-full mb-3'></div>
      <p className='w-1/2'>Explore int+ journey, defined by transformative milestones, showcasing our unwavering commitment to excellence and innovation.</p>
      <div className='flex justify-between'>
        <div className='flex flex-col gap-3 items-center p-2  w-[200px] justify-center text-center'>
