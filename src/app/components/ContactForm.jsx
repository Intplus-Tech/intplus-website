...
const ContactForm = () => {
    return (
        <div className="w-full h-auto relative p-7 lg:px-20 lg:p-0 lg:py-10 flex items-center justify-end text-[#16205F] mt-5">
            <div className="bg-servicesBackground rounded-[4px] lg:ml-20 rounded-br-[50px] h-full w-[65%] absolute top-0 left-0 z-[-10]"></div>
            <form action="" className=" rounded-[4px] rounded-tl-[70px] p-[50px] ml-3 lg:ml-0 lg:w-1/2 max-w-[700px] bg-white shadow-xl">
                ...
                <div className="flex flex-col gap-y-2 mb-3">
                    ...
                    <textarea name="details" id="details" className='outline-none border-[#C5E0FF] border rounded-[4px] min-~h-[55px] resize-none p-2'></textarea>
                </div>
