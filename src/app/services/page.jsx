  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between overflow-x-hidden relative">
      ...
      <div className="bg-[#F9F9FF] w-full h-auto p-7 lg:px-20 lg:py-10 text-[#333333] flex flex-col items-center text-center">
        ...
        <p className="text-[16px] lg:w-[70%] mt-4 text-[#2D3748]">Take a look at the open Scale your business with our end-to-end software development solutions. int+ technology delivers a full-cycle software development services that adapt seamlessly to your project requirements and business needs.
        </p>
      </div>
      <ServiceList />
      <ContactForm />
