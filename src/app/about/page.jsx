...
const About = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-between overflow-x-hidden relative">
        ...
        <p className="text-[16px] lg:w-[70%] mt-4 text-[#2D3748]">Int+ provides tailored software solutions and services that empower businesses to grow and meet the challenges of tomorrow. We are a team that view solution from a global perspective and a proven track record in creating and accelerating innovations for companies for industries.</p>
        <p className='text-[16px] mt-7 lg:w-[80%]'>Bringing together a solution driven engineering team and industry expertise we help businesses navigate the technology maze in Real Estate, Fintech, Utilities, IT, Logistics, E-Commerce & Retail, Oil & Gas and others.</p>
        </div>
        <CoreValues/>
        <ContactForm/>
        <Footer/>
